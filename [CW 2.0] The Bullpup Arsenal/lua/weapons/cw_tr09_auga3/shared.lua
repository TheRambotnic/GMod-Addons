if CustomizableWeaponry then
	...
	if CLIENT then
		...
		SWEP.SprintAng = Vector(-15, 45, -15)

		SWEP.AlternativePos = Vector(-0.5, 1, -1)
		SWEP.AlternativeAng = Vector(0, 0, 0)
		
		SWEP.BackupSights = {
			["md_acog"] = {[1] = Vector(-2.995, -4, -0.86), [2] = Vector(0, 0.2, 0)}
		}
		...
		SWEP.AttachmentModelsVM = {
			...
			["md_schmidt_shortdot"] = {type = "Model", model = "models/cw2/attachments/schmidt.mdl", bone = "body", rel = "", pos = Vector(-0.26, -2.3, -4.8), adjustment = {min = -3.88, max = 3.6, axis = "y", inverse = true, inverseOffsetCalc = true}, angle = Angle(0, -90, 0), size = Vector(0.75, 0.75, 0.75)},
			["md_acog"] = {type = "Model", model = "models/wystan/attachments/2cog.mdl", bone = "body", pos = Vector(-0.3, -2.6, -5.1), adjustment = {min = -4.15, max = 3.25, axis = "y", inverse = true, inverseOffsetCalc = true}, angle = Angle(0, 0, 0), size = Vector(0.8, 0.8, 0.8)},
			["md_aimpoint"] = {type = "Model", model = "models/wystan/attachments/aimpoint.mdl", bone = "body", rel = "", pos = Vector(-0.23, -4, -5.32), adjustment = {min = -4.74, max = 3.13, axis = "y", inverse = true, inverseOffsetCalc = true}, angle = Angle(0, 0, 0), size = Vector(0.85, 0.85, 0.85)},
			["md_eotech"] = {type = "Model", model = "models/wystan/attachments/2otech557sight.mdl", bone = "body", rel = "", pos = Vector(0.25, -8.2, -10.66), adjustment = {min = -8.82, max = -1.96, axis = "y", inverse = true, inverseOffsetCalc = true}, angle = Angle(3, -90, 0), size = Vector(0.9, 0.9, 0.9)},
			...
			["md_fas2_eotech"] = {type = "Model", model = "models/c_fas2_eotech.mdl", bone = "body", rel = "", pos = Vector(0.02, 4.5, -1), adjustment = {min = 3.8, max = 10.8, axis = "y", inverse = true, inverseOffsetCalc = true}, angle = Angle(0, -90, 0), size = Vector(1, 1, 1)},
			["md_fas2_aimpoint"] = {type = "Model", model = "models/c_fas2_aimpoint_rigged.mdl", bone = "body", rel = "", pos = Vector(0.02, 4.3, -1.23), adjustment = {min = 3.27, max = 11.5, axis = "y", inverse = true, inverseOffsetCalc = true}, angle = Angle(0, -90, 0), size = Vector(1, 1, 1)},
			...
			["md_cod4_aimpoint_v2"] = {type = "Model", model = "models/v_cod4_aimpoint.mdl", bone = "body", rel = "", pos = Vector(0, -2.2, -3.2), adjustment = {min = -2.92, max = 3.72, axis = "y", inverse = true, inverseOffsetCalc = true}, angle = Angle(0, 90, 0), size = Vector(0.8, 0.8, 0.8)},
			["angled_foregrip"] = {type = "Model", model = "models/attachments/handguard/angled_foregrip.mdl", bone = "body", rel = "", pos = Vector(1.81, -3.7, 0.6), angle = Angle(0, 0, 0), size = Vector(0.8, 0.9, 0.8)},
			["trijicon_rx01"] = {type = "Model", model = "models/attachments/sights/trijicon_rx01.mdl", bone = "body", rel = "", pos = Vector(-0.01, 1.1, -0.48), adjustment = {min = 0.15, max = 7.9, axis = "y", inverse = true, inverseOffsetCalc = true}, angle = Angle(0, -90, 0), size = Vector(0.8, 0.8, 0.8)},
			["cmore_railway"] = {type = "Model", model = "models/attachments/sights/cmore_railway.mdl", bone = "body", rel = "", pos = Vector(0, 1.3, -0.44), adjustment = {min = 0.8, max = 8.15, axis = "y", inverse = true, inverseOffsetCalc = true}, angle = Angle(0, -90, 0), size = Vector(0.85, 0.85, 0.85)},
			["codmwr_red_dot"] = {type = "Model", model = "models/attachments/sights/codmwr_red_dot.mdl", bone = "body", rel = "", pos = Vector(0, 1.4, -0.61), adjustment = {min = 0.8, max = 8.73, axis = "y", inverse = true, inverseOffsetCalc = true}, angle = Angle(0, -90, 0), size = Vector(0.82, 0.82, 0.82)},
			["coyote_reddot"] = {type = "Model", model = "models/attachments/sights/coyote_reddot.mdl", bone = "body", rel = "", pos = Vector(0, 1.15, -0.59), adjustment = {min = -0.12, max = 7.98, axis = "y", inverse = true, inverseOffsetCalc = true}, angle = Angle(0, -90, 0), size = Vector(0.95, 0.95, 0.95)},
			["hd33_sight"] = {type = "Model", model = "models/attachments/sights/hd33.mdl", bone = "body", rel = "", pos = Vector(0, 2.1, -4.36), adjustment = {min = 0.87, max = 9.38, axis = "y", inverse = true, inverseOffsetCalc = true}, angle = Angle(0, -90, 0), size = Vector(0.55, 0.55, 0.55)},
			["grip_pod"] = {type = "Model", model = "models/attachments/handguard/grip_pod.mdl", bone = "body", rel = "", pos = Vector(1.5, -4.5, 0.6), angle = Angle(0, 0, 0), size = Vector(0.7, 0.8, 0.85)},
			["md_microt1"] = {type = "Model", model = "models/cw2/attachments/microt1.mdl", bone = "body", pos = Vector(0, 1.1, -0.4), adjustment = {min = 0.13, max = 9.03, axis = "y", inverse = true, inverseOffsetCalc = true}, angle = Angle(0, -180, 0), size = Vector(0.35, 0.35, 0.35)},
			["md_anpeq15"] = {type = "Model", model = "models/cw2/attachments/anpeq15.mdl", bone = "body", pos = Vector(0.8, 10.45, -1.9), adjustment = {min = 9.7, max = 11.3, axis = "y", inverse = true, inverseOffsetCalc = true}, angle = Angle(-180, -90, -90), size = Vector(0.5, 0.5, 0.5)},
			["harris_bipod"] = {type = "Model", model = "models/attachments/handguard/harris_bipod.mdl", bone = "body", rel = "", pos = Vector(0.02, 9.2, -3.25), angle = Angle(0, -90, 0), size = Vector(0.55, 0.55, 0.55)},
		...
		SWEP.WElements = {
			...
			["angled_foregrip"] = {type = "Model", model = "models/attachments/handguard/angled_foregrip.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-3.4, 3.25, -7.2), angle = Angle(0, -90, 180), size = Vector(1.1, 1.2, 1.1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}},
			["trijicon_rx01"] = {type = "Model", model = "models/attachments/sights/trijicon_rx01.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(2.9, 0.78, -5.8), angle = Angle(0, 0, -180), size = Vector(1.2, 1.2, 1.2), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}},
			["cmore_railway"] = {type = "Model", model = "models/attachments/sights/cmore_railway.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(2.9, 0.82, -5.85), angle = Angle(180, -180, 0), size = Vector(1.2, 1.2, 1.2), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}},
			["codmwr_red_dot"] = {type = "Model", model = "models/attachments/sights/codmwr_red_dot.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.6, 0.8, -5.6), angle = Angle(0, 0, -180), size = Vector(1.1, 1.1, 1.1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}},
			["coyote_reddot"] = {type = "Model", model = "models/attachments/sights/coyote_reddot.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(2.9, 0.8, -5.65), angle = Angle(0, 0, -180), size = Vector(1.4, 1.4, 1.4), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}},
			["hd33_sight"] = {type = "Model", model = "models/attachments/sights/hd33.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(4.7, 0.8, -0.16), angle = Angle(180, -180, 0), size = Vector(0.8, 0.8, 0.8), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}},
			["grip_pod"] = {type = "Model", model = "models/attachments/handguard/grip_pod.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(0.46, 2.5, -6.35), angle = Angle(0, -90, 180), size = Vector(0.8, 0.8, 0.95), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}},
			...
			["harris_bipod"] = {type = "Model", model = "models/attachments/handguard/harris_bipod.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(17, 0.8, -2), angle = Angle(0, 0, -180), size = Vector(0.6, 0.6, 0.6), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}},
	...
	-- lua_run Entity(1):GetViewModel():SetBodygroup(BG category, Subcategory)
	SWEP.SightBGs = {main = 2, regular = 0, none = 1}
	SWEP.MagBGs = {main = 3, regular = 0, extmag = 1}
	SWEP.BarrelBGs = {main = 4, regular = 0, heavy = 1}
	...
	function SWEP:IndividualThink()
		...
		-- Why use an 'elseif statement' instead of putting them in the same condition?
		-- Because I wanted to have different zoom levels for each scope.
		if self.ActiveAttachments.md_schmidt_shortdot or self.ActiveAttachments.md_fas2_leupold then
			self.AimBreathingEnabled = true
			self.AdjustableZoom = true
			self.MinZoom = 10
			self.MaxZoom = 30
		elseif self.ActiveAttachments.md_magnifier_scope or self.ActiveAttachments.md_acog then
			self.AimBreathingEnabled = true
			self.AdjustableZoom = true
			self.MinZoom = 10
			self.MaxZoom = 20
		...
		if self.ActiveAttachments.auga3_silencer then
			if self.ActiveAttachments.auga3_heavybarrel then
	...
	SWEP.AttachmentPosDependency = {
		["md_saker"] = {["auga3_heavybarrel"] = Vector(-0.02, 4.3, -4.08)},
	...
	if CustomizableWeaponry_KK_HK416 then
		SWEP.Attachments = {
			[1] = {header = "Sight", offset = {500, -400}, atts = {"md_microt1", "cmore_railway", "hd33_sight", "codmwr_red_dot", "coyote_reddot", "trijicon_rx01", "md_eotech", "md_fas2_eotech", "md_cod4_aimpoint_v2", "md_aimpoint", "md_fas2_aimpoint", "md_schmidt_shortdot", "md_acog", "md_fas2_leupold"}},
			...
			[6] = {header = "Barrel", offset = {-100, -400}, atts = {"auga3_heavybarrel"}},
			[7] = {header = "Magazine", offset = {1200, 600}, atts = {"auga3_extmag"}},
			[8] = {header = "Reloading Method", offset = {1800, 100}, atts = {"auga3_catch"}},
		...
		SWEP.Attachments = {
			[1] = {header = "Sight", offset = {650, -400}, atts = {"md_microt1", "cmore_railway", "hd33_sight", "codmwr_red_dot", "coyote_reddot", "trijicon_rx01", "md_eotech", "md_aimpoint", "md_schmidt_shortdot", "md_acog"}},
			...
			[5] = {header = "Barrel", offset = {50, -400}, atts = {"auga3_heavybarrel"}},
			[6] = {header = "Magazine", offset = {1200, 600}, atts = {"auga3_extmag"}},
			[7] = {header = "Reloading Method", offset = {1200, 100}, atts = {"auga3_catch"}},
			["impulse 100"] = {header = "Skins", offset = {450, 600}, atts = {"auga3_white", "auga3_tan", "auga3_green"}},
	...
	SWEP.Sounds = {
		first_draw = {
			[1] = {time = 0, sound = "CW_AUGA3_DEPLOY"},
			[2] = {time = 0.4, sound = "CW_AUGA3_BOLTPULL"},
			[3] = {time = 0.55, sound = "CW_AUGA3_BOLTRELEASE"}
		},
		
		draw = {
			{time = 0, sound = "CW_AUGA3_CLOTH"}
		},

		reload = {
			[1] = {time = 0.5, sound = "CW_AUGA3_MAGRELEASE"},
	...
	if USE_OLD_WELEMENTS then
		...
		if CLIENT then
			...
			function SWEP:WElementThink()
				...
				or self.ActiveAttachments.md_fas2_holo or self.ActiveAttachments.md_cod4_aimpoint_v2 or self.ActiveAttachments.md_aimpoint or self.ActiveAttachments.md_fas2_aimpoint
