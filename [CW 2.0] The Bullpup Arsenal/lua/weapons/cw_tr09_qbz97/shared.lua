if CustomizableWeaponry then
	...
	util.PrecacheModel("models/weapons/Rambotnic/v_cw2_qbz97.mdl")
	util.PrecacheModel("models/weapons/Rambotnic/w_cw2_qbz97.mdl")
	...
	if CLIENT then
		...
		function SWEP:getWorldAttachments()
			return self.WMEnt:GetAttachment(self.WMEnt:LookupAttachment(self.WorldShellEjectionAttachmentID, self.WorldMuzzleAttachmentID))
		end
		...
		SWEP.SprintAng = Vector(-20, 45, -15)
		...
		SWEP.BackupSights = {
			["md_acog"] = {[1] = Vector(-2.6, -5, -1.4), [2] = Vector(-0.05, -0.05, 0)}
		}
		...
		SWEP.AttachmentModelsVM = {
			...
			["trijicon_rx01"] = {type = "Model", model = "models/attachments/sights/trijicon_rx01.mdl", bone = "FAM_MAIN", rel = "", pos = Vector(0, -2.4, 3.52), adjustment = {min = 3.27, max = 11.5, axis = "y", inverse = true, inverseOffsetCalc = true}, angle = Angle(0, -90, 0), size = Vector(0.7, 0.7, 0.7)},
			["cmore_railway"] = {type = "Model", model = "models/attachments/sights/cmore_railway.mdl", bone = "FAM_MAIN", rel = "", pos = Vector(0, -1.6, 3.57), angle = Angle(0, -90, 0), size = Vector(0.9, 0.9, 0.9)},
			["codmwr_red_dot"] = {type = "Model", model = "models/attachments/sights/codmwr_red_dot.mdl", bone = "FAM_MAIN", rel = "", pos = Vector(0, -1.6, 3.41), angle = Angle(0, -90, 0), size = Vector(0.85, 0.85, 0.85)},
			["coyote_reddot"] = {type = "Model", model = "models/attachments/sights/coyote_reddot.mdl", bone = "FAM_MAIN", rel = "", pos = Vector(0, -2.6, 3.43), angle = Angle(0, -90, 0), size = Vector(0.95, 0.95, 0.95)},
			["hd33_sight"] = {type = "Model", model = "models/attachments/sights/hd33.mdl", bone = "FAM_MAIN", rel = "", pos = Vector(0, -1.5, -0.36), angle = Angle(0, -90, 0), size = Vector(0.55, 0.55, 0.55)},
			["qbz97_grippod"] = {type = "Model", model = "models/attachments/handguard/grip_pod.mdl", bone = "FAM_MAIN", rel = "", pos = Vector(2.2, -12.5, 3.5), angle = Angle(0, 0, 0), size = Vector(1, 1, 1)},
			...
			["harris_bipod"] = {type = "Model", model = "models/attachments/handguard/harris_bipod.mdl", bone = "FAM_MAIN", rel = "", pos = Vector(-0.05, 6.4, -1), angle = Angle(0, -90, 0), size = Vector(0.6, 0.6, 0.6)},
		...
		SWEP.WElements = {
			...
			["trijicon_rx01"] = {type = "Model", model = "models/attachments/sights/trijicon_rx01.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3.2, 1.1, -7.3), angle = Angle(0, 0, -180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}},
			["cmore_railway"] = {type = "Model", model = "models/attachments/sights/cmore_railway.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(4, 1.03, -7.43), angle = Angle(0, 0, -180), size = Vector(1.1, 1.1, 1.1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}},
			["codmwr_red_dot"] = {type = "Model", model = "models/attachments/sights/codmwr_red_dot.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(4, 1.03, -7.2), angle = Angle(0, 0, -180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}},
			["coyote_reddot"] = {type = "Model", model = "models/attachments/sights/coyote_reddot.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(3, 1.05, -7.25), angle = Angle(0, 0, -180), size = Vector(1.2, 1.2, 1.2), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}},
			["hd33_sight"] = {type = "Model", model = "models/attachments/sights/hd33.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(4.8, 1.05, -2.45), angle = Angle(0, 0, -180), size = Vector(0.7, 0.7, 0.7), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}},
			["qbz97_grippod"] = {type = "Model", model = "models/attachments/handguard/grip_pod.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(-6, 3.45, -7.1), angle = Angle(0, -90, -180), size = Vector(1.1, 1.1, 1.2), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}},
			...
			["harris_bipod"] = {type = "Model", model = "models/attachments/handguard/harris_bipod.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(14.5, 1, -1.5), angle = Angle(0, 0, -180), size = Vector(0.6, 0.6, 0.6), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}},
	...
	if CustomizableWeaponry_KK_HK416 then
		SWEP.Attachments = {
			[1] = {header = "Sight", offset = {200, -550}, atts = {"md_microt1", "cmore_railway", "hd33_sight", "codmwr_red_dot", "coyote_reddot", "trijicon_rx01", "md_eotech", "md_fas2_eotech", "md_aimpoint", "md_cod4_aimpoint_v2", "md_fas2_aimpoint", "md_schmidt_shortdot", "md_acog", "md_fas2_leupold"}},
	...
	--		["impulse 100"] = {header = "Skins", offset = {850, 300}, atts = {"qbz97_scifi"}},
		...
		SWEP.Attachments = {
			[1] = {header = "Sight", offset = {500, -500}, atts = {"md_microt1", "cmore_railway", "hd33_sight", "codmwr_red_dot", "coyote_reddot", "trijicon_rx01", "md_eotech", "md_aimpoint", "md_schmidt_shortdot", "md_acog"}},
	...
	SWEP.Sounds = {
		base_draw = {
			{time = 0, sound = "CW_QBZ97_CLOTH"}
		},

		base_ready = {
			[1] = {time = 0, sound = "CW_QBZ97_CLOTH"},
	...
	SWEP.ViewModel = "models/weapons/Rambotnic/v_cw2_qbz97.mdl"
	SWEP.WorldModel	= "models/weapons/Rambotnic/w_cw2_qbz97.mdl"
	SWEP.DrawTraditionalWorldModel = false
	SWEP.WM = "models/weapons/Rambotnic/w_cw2_qbz97.mdl"
