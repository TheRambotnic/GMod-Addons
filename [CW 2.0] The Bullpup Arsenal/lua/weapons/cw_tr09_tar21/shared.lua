if CustomizableWeaponry then
	...
	util.PrecacheModel("models/weapons/Rambotnic/v_cw2_tar21.mdl")
	util.PrecacheModel("models/weapons/Rambotnic/w_cw2_tar21.mdl")
	...
	if CLIENT then
		...
		SWEP.PrintName = "IWI Tavor TAR-21"
		...
		SWEP.BackupSights = {
			["acog_fixed"] = {[1] = Vector(-1.84, -3, -1.06), [2] = Vector(1, 0, 0)}
		}
		...
		SWEP.AttachmentModelsVM = {
			...
			["trijicon_rx01"] = {type = "Model", model = "models/attachments/sights/trijicon_rx01.mdl", bone = "Receiver", rel = "", pos = Vector(0.02, -2.7, 1.2), angle = Angle(-90, 0, -90), size = Vector(0.8, 0.8, 0.8)},
			["cmore_railway"] = {type = "Model", model = "models/attachments/sights/cmore_railway.mdl", bone = "Receiver", rel = "", pos = Vector(0, -2.75, 1.1), angle = Angle(-90, 0, -90), size = Vector(0.85, 0.85, 0.85)},
			["codmwr_red_dot"] = {type = "Model", model = "models/attachments/sights/codmwr_red_dot.mdl", bone = "Receiver", rel = "", pos = Vector(0, -2.58, 0.6), angle = Angle(-90, -90, 180), size = Vector(0.8, 0.8, 0.8)},
			["coyote_reddot"] = {type = "Model", model = "models/attachments/sights/coyote_reddot.mdl", bone = "Receiver", rel = "", pos = Vector(0, -2.62, 1.5), angle = Angle(-90, 0, -90), size = Vector(0.9, 0.9, 0.9)},
			["hd33_sight"] = {type = "Model", model = "models/attachments/sights/hd33.mdl", bone = "Receiver", rel = "", pos = Vector(0, 1.18, 0.5), angle = Angle(-90, 0, -90), size = Vector(0.55, 0.55, 0.55)},
			...
			["tar21_mvg"] = {type = "Model", model = "models/attachments/handguard/magpulgrip.mdl", bone = "Receiver", pos = Vector(-0.392, -3.997, -1.839), angle = Angle(0, 0, 0), size = Vector(0.75, 0.75, 0.75)},
		...
		SWEP.WElements = {
			...
			["trijicon_rx01"] = {type = "Model", model = "models/attachments/sights/trijicon_rx01.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(6.2, 0.55, -5.7), angle = Angle(0, 0, 180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}},
			["cmore_railway"] = {type = "Model", model = "models/attachments/sights/cmore_railway.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(6.4, 0.55, -5.72), angle = Angle(0, 0, 180), size = Vector(1.05, 1.05, 1.05), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}},
			["codmwr_red_dot"] = {type = "Model", model = "models/attachments/sights/codmwr_red_dot.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(7, 0.53, -5.52), angle = Angle(0, 0, -180), size = Vector(1, 1, 1), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}},
			["coyote_reddot"] = {type = "Model", model = "models/attachments/sights/coyote_reddot.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(6, 0.55, -5.55), angle = Angle(0, 0, 180), size = Vector(1.3, 1.3, 1.3), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}},
			["hd33_sight"] = {type = "Model", model = "models/attachments/sights/hd33.mdl", bone = "ValveBiped.Bip01_R_Hand", rel = "", pos = Vector(7.7, 0.55, -0.7), angle = Angle(0, 0, 180), size = Vector(0.7, 0.7, 0.7), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}},
			...
			["tar21_mvg"] = {type = "Model", model = "models/attachments/handguard/magpulgrip.mdl", bone = "ValveBiped.Bip01_R_Hand", pos = Vector(-0.392, -3.997, -1.839), angle = Angle(0, 0, 0), size = Vector(0.75, 0.75, 0.75), color = Color(255, 255, 255, 255), surpresslightning = false, material = "", skin = 0, bodygroup = {}},
	...
	--[[
		...
		SWEP.LaserPosAdjust = Vector(0.5, 0, 0.2)
	...
	if CustomizableWeaponry_KK_HK416 then
		SWEP.Attachments = {[1] = {header = "Sight", offset = {300, -400}, atts = {"md_microt1", "cmore_railway", "hd33_sight", "codmwr_red_dot", "coyote_reddot", "trijicon_rx01", "md_eotech", "md_fas2_eotech", "md_aimpoint", "md_fas2_aimpoint", "acog_fixed"}},
		...
		SWEP.Attachments = {[1] = {header = "Sight", offset = {300, -400}, atts = {"md_microt1", "cmore_railway", "hd33_sight", "codmwr_red_dot", "coyote_reddot", "trijicon_rx01", "md_eotech", "md_aimpoint", "acog_fixed"}},
	...
	SWEP.Author			= "Rambotnic" -- This was actually Dzembi's weapon. Consider this as an "improvement" of his original addon.
	...
	SWEP.ViewModel		= "models/weapons/Rambotnic/v_cw2_tar21.mdl"
	SWEP.WorldModel		= "models/weapons/Rambotnic/w_cw2_tar21.mdl"
	SWEP.DrawTraditionalWorldModel = false
	SWEP.WM = "models/weapons/Rambotnic/w_cw2_tar21.mdl"
