...
if CLIENT then
	...
	att.description = {
		[1] = {t = "Changes the weapon's body to a Tan look.", c = CustomizableWeaponry.textColors.COSMETIC}
	}
end
...
if CLIENT then
	...
	att.description = {
		[1] = {t = "Changes the gun to a futuristic look.", c = CustomizableWeaponry.textColors.COSMETIC}
	}
end
