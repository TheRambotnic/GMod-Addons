...
if CLIENT then
	...
	att.description = {
		[1] = {t = "Provides a more comfortable foregrip option.", c = CustomizableWeaponry.textColors.REGULAR}
	}
end
...
if CLIENT then
	...
	att.description = {
		[1] = {t = "Press your use key to deploy on a nearby surface.", c = CustomizableWeaponry.textColors.REGULAR},
		[2] = {t = "WHEN DEPLOYED: Decreases recoil by 70%", c = CustomizableWeaponry.textColors.VPOSITIVE}
	}
end
...
function att:elementRender()
	...
	if is ~= was then
		if is then
			...
			self:EmitSound("CW_GRIP_POD_DOWN")
		else
			self.AttachmentModelsVM.grip_pod.ent:SetBodygroup(1,0)
			self:EmitSound("CW_GRIP_POD_UP")
		end	
	end
...
CustomizableWeaponry:addReloadSound("CW_GRIP_POD_DOWN", {"attachments/grippod_swivel_01.wav", "attachments/grippod_swivel_02.wav"})
CustomizableWeaponry:addReloadSound("CW_GRIP_POD_UP", "attachments/grippod_swivel_retract.wav")
...
CustomizableWeaponry:addReloadSound("CW_HarrisBipod_Down", {"attachments/harrisbipod_down1.wav", "attachments/harrisbipod_down2.wav"})
CustomizableWeaponry:addReloadSound("CW_HarrisBipod_Up", {"attachments/harrisbipod_up1.wav", "attachments/harrisbipod_up2.wav"})