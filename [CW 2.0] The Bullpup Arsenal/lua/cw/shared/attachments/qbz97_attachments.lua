...
if CLIENT then
    ...
    att.description = {
		[1] = {t = "A clean, semi-recent black look for your gun.", c = CustomizableWeaponry.textColors.COSMETIC}
	}
end
...
if CLIENT then
    ...
    att.description = {
		[1] = {t = "Changes your gun to a Futuristic look.", c = CustomizableWeaponry.textColors.COSMETIC}
	}
end
